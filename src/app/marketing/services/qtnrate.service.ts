...
import { Tbl_Cargo_Qtn_Rates, QtnRateModel, vm_tbl_cargo_qtn_rates } from '../models/tbl_cargo_qtn_rates';
...
export class QtnRateService {

    private mdata$ = new BehaviorSubject<QtnRateModel>(null);
    get data$(): Observable<QtnRateModel> {
        return this.mdata$.asObservable();
    }
    private record: QtnRateModel;

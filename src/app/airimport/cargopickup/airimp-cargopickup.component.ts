...
import { AirImpCargoPickupService } from '../services/airimp-cargopickup.service';
...
@Component({
  ...
  templateUrl: './airimp-cargopickup.component.html'
})
export class AirImpCargoPickupComponent implements OnInit {
  ...
  constructor(
    ...
    private mainService: AirImpCargoPickupService,
  ) { }

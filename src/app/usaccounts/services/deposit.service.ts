...
export class DepositService {
    ...
    List(SearchData: any) {
        return this.http2.post<any>(this.gs.baseUrl + '/api/Deposit/List', SearchData, this.gs.headerparam2('authorized'));
    }

    GetRecord(SearchData: any) {
        return this.http2.post<any>(this.gs.baseUrl + '/api/Deposit/GetRecord', SearchData, this.gs.headerparam2('authorized'));
    }

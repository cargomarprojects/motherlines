...
import { Tbl_cargo_exp_housem, AirExpHouseModel, vm_tbl_cargo_exp_housem } from '../models/tbl_cargo_exp_housem';
...
export class AirExpHouseService {

    private mdata$ = new BehaviorSubject<AirExpHouseModel>(null);
    get data$(): Observable<AirExpHouseModel> {
        return this.mdata$.asObservable();
    }
    private record: AirExpHouseModel;
